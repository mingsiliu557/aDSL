...
- Material ID: `adsl-final-standing-stability-20260906T071813Z`
- Type: experiment validation report
- Verification Status: ANALYZED
- Generated (UTC): 2026-09-06T07:18:13.347158+00:00
- Input root: `/jiigan-hp/lms/aDSL/experiment/physics_analysis/01_unstable_case_validation_20260904/cpu_pilot_attempt_01`
- MuJoCo coverage: 2/2 non-excluded states
- Free-settle falls (>25°): 1/2 non-excluded states
...
|---|---|---:|---:|---:|---:|---:|---|---:|---:|
| U01 | INDETERMINATE | low | 0.7192 | — | 0.4695 | 17.15 | upright | 0.00 | 0.50 |
| U05 | UNSTABLE | high | 0.0000 | — | — | 0.00 | TIPPED | 97.14 | 0.05 |

## 逐项结果

### U01

- URDF SHA256: `57ecc94f068818805ba85681e44b269bfd90a782372711b4bcc8b6c416c44731`
- Movable joints: 0
...
- Joint values: `{}`
- Support: 32 points, rank=2, area=0.7192, mesh-only=True.
- Uniform solid: available=False, margin=—, normalized=—, tip angle=—°.
- Uniform shell: available=True, margin=0.4695, normalized=0.2699, tip angle=17.15°.
...
- MuJoCo: natural fall (>25°)=False, settle max tilt=0.00°, settle final tilt=0.00°, contacts=2, min observed F/W=0.50, impulse tipped directions=0/16, dropped zero-volume mesh fragments=43.
### U05
...
- Joint values: `{}`
- Support: 1 points, rank=0, area=0.0000, mesh-only=True.
...
- MuJoCo: natural fall (>25°)=True, settle max tilt=97.14°, settle final tilt=96.50°, contacts=2, min observed F/W=0.05, impulse tipped directions=16/16, dropped zero-volume mesh fragments=0.
...
- Shapely: `2.1.2`
- MuJoCo: `3.12.0`
- Command: `experiments/final_standing_stability/analyze.py --input-root /jiigan-hp/lms/aDSL/experiment/physics_analysis/01_unstable_case_validation_20260904/cpu_pilot_attempt_01 --output-dir /jiigan-hp/lms/aDSL/experiment/physics_analysis/01_unstable_case_validation_20260904/cpu_pilot_attempt_01_analysis --mujoco-pythonpath /jiigan-hp/lms/aDSL/experiment/runtime/mujoco-py310 --physics on`
